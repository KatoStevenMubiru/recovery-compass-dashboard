...
import { DailyTaskList, Task } from "@/components/dashboard/widgets/DailyTaskList";
import { RecoveryGoalsList } from "@/components/dashboard/widgets/RecoveryGoalsList";
import { userProfile, dailyTasks as mockDailyTasks } from "@/services/mockData";
            ...
            <div className="flex justify-end mb-2">
              <Sheet open={isAddTaskSheetOpen} onOpenChange={setIsAddTaskSheetOpen}>
                ...
                <SheetContent side="right">
                  ...
                  <AddTaskForm onAddTask={addTask} onClose={() => setIsAddTaskSheetOpen(false)} />
                </SheetContent>
              </Sheet>
            </div>
