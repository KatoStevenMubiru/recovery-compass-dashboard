      ...
      <div className="space-y-6">
        <div className="flex flex-col gap-2 mb-6">
          <div className="flex items-center justify-between">
            <h1 className="text-3xl font-bold text-primary">Recovery & Support Resources</h1>
        ...
        <Card className="gradient-card border-0 shadow-md">
          <CardHeader className="pb-2">
            <CardTitle className="text-lg text-primary">Recovery Resources</CardTitle>
          ...
          <CardContent className="p-5">
            <Tabs defaultValue="counselors" value={activeTab} onValueChange={setActiveTab} className="w-full">
                    ...
                    <Card key={index} className="gradient-card border-0 shadow-md">
                      <CardHeader className="pb-2">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <CardTitle className="text-lg text-primary">{counselor.name}</CardTitle>
              ...
              <TabsContent value="videos" className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  {resourcesData.videos.map((video, index) => (
                    <Card key={index} className="gradient-card border-0 shadow-md">
                      <CardHeader className="pb-2">
                        <CardTitle className="text-base text-primary">{video.title}</CardTitle>
                      </CardHeader>
                      <CardContent>
              ...
              <TabsContent value="articles" className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  {resourcesData.articles.map((article, index) => (
                    <Card key={index} className="gradient-card border-0 shadow-md">
                      <CardHeader className="pb-2">
                        <CardTitle className="text-base text-primary">{article.title}</CardTitle>
              ...
              <TabsContent value="academic" className="space-y-4">
                ...
                <Card className="gradient-card border-0 shadow-md">
                  <CardHeader className="pb-2">
                    <CardTitle className="text-lg text-primary">Academic Support for Recovery</CardTitle>
                    <CardDescription>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {resourcesData.academicResources.map((resource, index) => (
                        <div key={index} className="border rounded-lg p-4 gradient-card border-0 shadow-md">
                          <h3 className="font-medium text-lg text-primary mb-1">{resource.name}</h3>
                          <p className="text-sm text-muted-foreground mb-4">{resource.description}</p>
